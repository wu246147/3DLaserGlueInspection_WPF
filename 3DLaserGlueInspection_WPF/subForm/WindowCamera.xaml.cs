...
namespace _3DLaserGlueInspection.subForm
{
    ...
    public partial class WindowCamera : System.Windows.Window
    {
        ...
        private void setCurrentOffsetButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                ShowMessage(_3DLaserGlueInspection.Resources.LanguageDict.HorizontalOffsetParameterValue + 参数值offsetX.ToString() + _3DLaserGlueInspection.Resources.LanguageDict.CameraValue + 相机值offsetX.ToString());
            }
            else
            {
